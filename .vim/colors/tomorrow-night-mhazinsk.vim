" Overmorrow Night - Full Colour and 256 Colour
" Fork of tomorrow-night by http://chriskempson.com
"
" Hex colour conversion functions borrowed from the theme "Desert256""
"
" Matt Hazinski <matt@matthazinski.com>. Changes from tomorrow-night:
" - Unset console bg color to allow transparent backgrounds in xfce4-terminal
" - Make status line less obtrusive (foreground white, no background)
...
let g:colors_name = "overmorrow-night"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	fun <SID>X(group, fg, bg, attr)
		...
		if a:bg != ""
            ...
            " Unsets background color so transparent windows can be used.
            exec "hi Normal ctermbg=none"
            exec "hi StatusLine ctermbg=none cterm=none ctermfg=303030"
		endif
		if a:attr != ""
